...
##LOAD DATA
```{r}
candy <- read.csv("C:\\Marion\\candy_production.csv")
...
Boxplot reveals that candy production is higher in months 10 to 12, having higher means and lower variances than the other months, indicating seasonality with an apparent cycle of 12 months.
